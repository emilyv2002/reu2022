...
load_prev_weights = False # don't have any previous weights
resume = False
seed = 0
model_name = 'resnet3D'
...
model = torch.load('/home/em585489/mama_dataloader/pretrained_weights/data/r3d18_K_200ep.pth')
...
def train_one_epoch(epoch, tb_writer, train_loader=None):
